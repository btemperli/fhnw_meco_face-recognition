...
function initFaceTracker() {
	...
	_stage.addChild(new nxtjs.FaceTracker());
}
...
(function(lib) {
	...
	(lib.FaceTracker = function(
		...
		_this.updateGUI = function() {
            ...
            if (!window.startedAnalyse && initialised && faceShape.rotationX === 0 && faceShape.rotationZ === 0 && faceShape.rotationY === 0) {

                window.startedAnalyse = true;
