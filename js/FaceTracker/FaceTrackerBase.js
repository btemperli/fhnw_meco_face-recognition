if(nxtjs == null) {
	throw "FaceTrackerBase.js needs a fully initialized Beyond Reality Face Nxt. SDK. Make sure to follow the implementation examples of the JS version of the SDK.";
}
if(createjs == null) {
	throw "FaceTrackerBase.js uses CreateJS to display its content. Make sure to follow the implementation examples of the JS version of the SDK.";
}
				...
				var constraints = {
					...
					"video": {
						"mandatory": {
							...
							"minFrameRate": "30",
							"maxWidth":		_this._cameraResolution.width,
							"maxHeight":	_this._cameraResolution.height,
							"maxFrameRate": "30"
						},
						"optional": []
					}
